...
export default function RecipeList() {
  ...
  const handleChangeCategory = (
    ...
    console.log(value);
    setCategoriesChosen(typeof value === "string" ? value.split(",") : value);
  };
  ...
  useEffect(() => {
    if (data) {
      ...
      if (categoriesChosen.length > 0 || areasChosen.length > 0 || searchTerm) {
    ...
    <div className="recipeListPage-container">
      <header className="home-header-container">
        ...
        {userLoggedIn ? (
          ...
          <div className="home-login">
            <a className="hover-underline-animation" href="/auth/login">
              Login
            </a>
            <span>or</span>
            <a className="hover-underline-animation" href="/auth/signup">
              Sign up
            </a>
          </div>
        )}
      ...
      <div className="filters">
        <div>
          <FormControl
            ...
            variant="outlined"
          >
            <InputLabel id="demo-multiple-chip-label" className="label-text">
              Category
            </InputLabel>
            <Select
              sx={{
      ...
      <div className="RecipeList-container">
        <InfiniteScroll
          ...
          hasMore={hasMore}
          loader={
            <div className="loader-recipelist">
              <Loader />
            </div>
          }
          endMessage={
